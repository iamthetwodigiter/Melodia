...
final offlineAudioPlayerProvider =
    StateNotifierProvider<OfflineAudioPlayerNotifier, AudioPlayerState>(
  (ref) => OfflineAudioPlayerNotifier(ref),
);

class OfflineAudioPlayerNotifier extends StateNotifier<AudioPlayerState> {
  final AudioPlayer _audioPlayer;
  List<AudioSource> _currentPlaylist = [];
  List<Songs> _songsList = [];
  final Ref ref;

  OfflineAudioPlayerNotifier(this.ref)
